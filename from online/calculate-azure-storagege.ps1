...
$resourceGroup = "CC-PROD-QRadarAIO"
$storageAccountName = "ccprodqradaraiodiag"
$containerName = "qradar-archive"
...
$listOfBlobs | ForEach-Object {$length = (($length + $_.Length)/1GB)}

# output the blobs and their sizes and the total 
Write-Host "List of Blobs and their size (length)"
Write-Host " " 
$listOfBlobs | Select-Object Name, Length
Write-Host " "
Write-Host "Total Length =  $($length / 1GB)"